...
$datetime=date("Y-m-d H:i:s");
    if($_REQUEST['data']=='confirm') {
        ...
        $sql= "INSERT INTO `orders`(`order_id`, `order_number`, `mem_id`, `address`, `order_shipping`, `price_total`, `order_status`, `order_date`) VALUES (NULL, '$order', '$mem_id', '$mem_address', '$shipping', '$summy', '0', '$datetime')";
...
?>
    ...
    <table class="table table-striped table-bordered" >
        ...
        if($_REQUEST['data']=='confirm') {
            ...
            $sqlins="INSERT INTO `order_detail`(`order_detail_id`, `order_number`, `product_id`, `product_price`) VALUES (null,'$order','$_SESSION[product_id]','$_SESSION[product_price]')";
    ...
    //$productsx_prices = array($_SESSION['product_price']);?>
            <td><?php echo $i;?></td>
            <td style="width:100px"><img src="image/store/<?php echo $rows['product_image']?>" style="width:100px"></td>
